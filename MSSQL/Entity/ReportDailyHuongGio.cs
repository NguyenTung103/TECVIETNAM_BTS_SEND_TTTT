...
{
    [Table("ReportDailyHuongGio")]
    public partial class ReportDailyHuongGio
    {
        ...
        public Nullable<double> HuongGioDacTrungNhieuNhat { get; set; }

        public Nullable<double> HuongGioDacTrungNhieuThuHai { get; set; }
