...
using System.Linq;
using BtsGetwayService.Core.Entities;

namespace BtsGetwayService.Data
{
    public class MogoRepository<Entity> : Core.Interfaces.IRepository<Entity> where Entity : MongoBaseEntity
    {
        ...
        /// danh sách Entity
        /// </summary>
        private readonly IMongoCollection<Entity> Entitys;
        ...
        /// </summary>
        public MogoRepository(string connectionString)
        {            
        ...
        ///// </summary>
        ///// <returns>IQueryable Entity</returns>
        //public virtual IEnumerable<Entity> Aggregate(PipelineDefinition<Entity, int> pipeline, AggregateOptions options)
        //{
        //    var query = Entitys.Aggregate(pipeline,options);            
        //    return query;
        //}
        //#endregion
    }
