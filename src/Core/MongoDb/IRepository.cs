...
namespace BtsGetwayService.Core.Interfaces
{
    /// <summary>
    ...
    public interface IRepository<Entity>
    {
        ...
        /// <returns></returns>
        Task<IEnumerable<Entity>> FindOption(Expression<Func<Entity, bool>> predicate);
        /// <summary>
        /// 
        /// </summary>
        /// <param name="predicate"></param>
        ...
        /// <returns></returns>
        IEnumerable<Entity> FindPagingOption(Expression<Func<Entity, bool>> predicate, int limit, int skip, out long total);
        /// <summary>
